...
import { DeleteUniv } from "../../../../redux/university/university.actions";
import { toast } from "react-hot-toast";

function DelUniv(props) {
  ...
  const handleSubmit = () => {
    ...
    dispatch(DeleteUniv(value, handleClose));
  };
  ...
  return (
    ...
    >
      <div className="flex align-items-center justify-content-start">
        ...
        />
        <span>
          Are you sure you want to delete <b>{value.nom} </b>? rewrite the
          university name to confirm the delete
        </span>
        <br />
      </div>
