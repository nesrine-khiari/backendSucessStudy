...
function WhiteNavBar() {
  ...
  const is_connected = useSelector((state) => state.UserReducer.isConnected);
      ...
      <nav className="navbar">
        <div className="left-side">
          <Link to={"/"} className="logo">
            <img src={footer_logo} alt="logo" width="150" />
          </Link>
        </div>
        <div className="right-side">
          <div className="dropdown navbar-link navbar_link_style me-4">
            ...
            >
              <Link
                href="#section-3"
                className="button-text nav_link_style title_second text-white"
              >
                Nos destination
              </Link>
            </button>
          ...
          <Link
            className={`navbar-link navbar_link_style title_second me-4 ${
              router.pathname === "/about-us" ? "active_nav_link" : "text-white"
            }`}
            to="/about-us"
          >
            A propos
          ...
          <Link
            className="navbar-link navbar_link_style title_second text-white me-4"
            to="/"
          >
            |
          </Link>
          ...
          {is_connected ? (
            <>
              <div className="navbar-link navbar_link_style title_second text-white me-4">
                <img
              ...
              <div className="dropdown navbar-link navbar_link_style ">
                ...
                >
                  <Link
                    href="#section-3"
                    className="button-text nav_link_style title_second text-white w-100"
                  >
                    {user_data && user_data?.firstName[0]}.{" "}
            ...
            <>
              <div className="navbar-link navbar_link_style title_second text-white me-4">
                <Link to="sing-in" className="bnt-seconncter-box">
                  Se Connceter
                </Link>
              </div>
            </>
