...
import { ChevronDown, Eye, Mail, Phone, User, X } from "react-feather";
import {
  Col,
  Form,
  Input,
...
import { SendFeedBack } from "../redux/user/user.actions";
import ReactCountryFlag from "react-country-flag";
// ** ==>

let ARRAY_NUMBER = [{"country":"Afghanistan","code":"93","iso":"AF"},
...
function ContactUs() {
  ...
  useEffect(() => {
    const { firstName, lastName, email, tel } = user;
    setFeedBack({ ...feedback, firstName, lastName, email, tel });
  }, [user]);
  ...
  const handle_clear = () => {
    setFeedBack({ ...feedback, comment: "", starsNumber: 1 });
  };

  const handle_submit = (e) => {
    e.preventDefault();
    console.log(feedback);
    dispatch(SendFeedBack(feedback, handle_clear));
  };
  useEffect(()=>{
    window.scrollTo(0, 0);
},[])
  return (
    <>
      <NavBar />
      <div className="container contact_us_width">
        <div className="w-100 mt-lg-1 pt-0 mb-1">
          <h1 className="sigup_title color_main title_forth">Contact</h1>
        </div>
        <Form className="mt-5" onSubmit={handle_submit}>
          ...
          <Row>
            ...
            />
                      ...
                      {ARRAY_NUMBER.map(x=>{
                             ...
                             return(
                              <li onClick={ e=>setSelected(x)}><span className="dropdown-item" style={{
              ...
              <div className="mb-5">
                ...
                <InputGroup className="border-0">
                  <textarea
                    id="message"
                    type="textarea"
                    className="form-control signup_input w-100 border_left"
                    placeholder="Message"
                    rows={7}
                    name="comment"
          ...
          <button className="btn main_btn w-100 signup_btn mb-2">
            Envoyer
          </button>
        </Form>
      </div>
