...
console.log("____________________________________________________________________________________",queryObj);
  if (model) {
  ...
  console.log("ttttttttttttttttttttttttttttttttttttttt",output);
  if (json) {
    return output;
  }
